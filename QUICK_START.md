...
В web-интерфейсе теперь можно открыть вкладку **Аккаунты** и добавить несколько Telegram-аккаунтов. Live-проверки автоматически используют ротацию аккаунтов из `sessions/`; если они не добавлены, работает старый одиночный режим через `.env`.
...
5. Аккаунт со статусом `active` сразу участвует в live-проверках.
